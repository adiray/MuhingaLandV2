...
public class SongsView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedAlbumName = intent.getStringExtra(ArtistView.EXTRA_SELECTED_ALBUM_NAME);
        selectedArtistName = intent.getStringExtra(ArtistView.EXTRA_SELECTED_ARTIST_NAME);


        //initialize the views
        songsSwipeRefreshLayout = findViewById(R.id.songs_view_songs_swipe_refresh);
        albumNameTv = findViewById(R.id.songs_view_album_name);
        artistNameTv = findViewById(R.id.songs_view_artist_name);


        //set up the albums recycler view
        songsRecyclerView = findViewById(R.id.songs_view_songs_recycler_view);
        songsRecyclerView.setHasFixedSize(true);
        songsRecyclerView.setLayoutManager(new GridLayoutManager(SongsView.this, 1, 1, false));
